document.addEventListener('DOMContentLoaded', () => {
    ...
    // const categories = {
    //     'Animais': ['Bilby', 'Vombate', 'Foraminífero', 'Jaritacaca', 'Tardígrado', 'Aie-aie'], 
    //     'Batalhas': ['Termópilas', 'Megido', 'Lys', 'Hastings', 'Trafalgar', 'Austerlitz'],
    //     'Cães': ['Vizsla', 'Kelpie', 'Pumi', 'Corgi', 'Dingo', 'Akita'],
    //     'Navegadores': ['Cão', 'Magalhães', 'Gama', 'Cabral', 'Dias', 'Albuquerque'],
    //     'Ducados': ['Brabante', 'Borgonha', 'Bretanha', 'Bavaria', 'Bar', 'Berry'],
    //     'Meses': ['Termidor', 'Brumário', 'Germinal', 'Pluvioso', 'Messidor', 'Ventoso']
    // }
    // const categories = {
    //     'Kpop': ['Rumi', 'Mira', 'Zoey', 'Jinu', 'Celine', 'Saja', 'Bobby', 'Gwi-Ma', 'Han'],
    //     'Rios': ['Tejo', 'Mondego', 'Minho', 'Guadiana', 'Douro', 'Zêzere', 'Sado', 'Lima', 'Cávado'],
    //     'Mamíferos': ['Golfinho', 'Baleia', 'Orca', 'Beluga', 'Manatim', 'Foca', 'Morsa', 'Narval', 'Cachalote'],
    ...
    // }
    // const categories = {
    //     'Animais': ['axalote', 'capivara', 'koala', 'gato', 'gaivota', 'elefante', 'hamster', 'girafa'],
    //     'Acessórios': ['batom ', 'bamdolete', 'óculos', 'aparelho', 'sombra ', 'brincos', 'piercing', 'colares'],
    //     'Árvores': ['pinheiro', 'sobreiro', 'jacarandá', 'limoeiro', 'laranjeira', 'macieira', 'nogueira', 'carvalho'],
    //     'Línguas': ['inglês', 'português', 'holandês', 'mandarim', 'francês', 'alemão', 'bokmal', 'suaíli'],
    //     'Corpo': ['estômago', 'coração', 'pele', 'unhas', 'pêlo', 'sangue', 'cérebro', 'olhos'],
    //     'Músicos': ['capicua', 'jonatas pires', 'lou reed', 'cat stevens', 'rosalia', 'beyonce', 'rui reininho', 'rumi'],
    //     'Frutos': ['figos', 'pitaia', 'mirtilos', 'papaia', 'lima', 'alperces', 'nozes', 'laranja'],
    //     'Apps': ['spotify', 'google', 'tiktok', 'youtube', 'googlemaps', 'instagram', 'netflix', 'whatsapp']
    // }
    const categories = {
        'Criaturas': ['Unicórnio', 'Sereia ', 'Fada', 'Gnomo', 'Leprechaun', 'Bruxa', 'Hipogrifo'],
        'Natureza': ['Rios', 'Árvores ', 'Plantas', 'Relva', 'Flores', 'Insectos ', 'Aves'], 
        'Mar': ['Algas', 'Peixes', 'Sal', 'Mini camarões ', 'Baleia', 'Barcos', 'Gaivotas'], 
        'Ilhas': ['Açores ', 'Vulcões ', 'Madeira', 'Pico', 'São Miguel ', 'São Jorge', 'Faial'],
        'Dragões': ['Desdentado', 'Tempestade ', 'Escarreta', 'Soluços ', 'Perna de peixe', 'Bocarra ', 'Brutalia'],
        'Aparelhos': ['Ventoinhas', 'Fogões ', 'Televisão ', 'Telemóvel', 'Secador', 'Aspirador', 'Candeeiro'], 
        'Coisas castanhas': ['Tronco de árvores ', 'Estantes', 'Chocolate ', 'Cocó ', 'Flores secas', 'Cabelos', 'Cortiça']
    }
